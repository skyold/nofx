...
import { LogOut, Loader2, Eye, EyeOff, Copy, Check, Filter } from 'lucide-react'
...
// Check if a decision record contains any trade actions
function hasTradeActions(decision: DecisionRecord): boolean {
    if (!decision.decisions || decision.decisions.length === 0) return false
    return decision.decisions.some((action: DecisionAction) => {
        const type = action.action.toLowerCase()
        return type.includes('open') || type.includes('close')
    })
}
        ...
        <DeepVoidBackground className="min-h-screen pb-12" disableAnimation>
            <div className="w-full px-4 md:px-8 relative z-10 pt-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    >
                        {/* Header */}
                        <div className="flex items-center gap-3 mb-5 pb-4 border-b border-white/5 shrink-0 flex-wrap">
                            <div
